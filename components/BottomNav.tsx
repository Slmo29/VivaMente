...
function HomeIcon({ active: _a }: IconProps) {
  return (
...
function EserciziIcon({ active: _a }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill={"none"} stroke="currentColor" strokeWidth={2} className="w-6 h-6 flex-shrink-0">
...
function ProgressiIcon({ active: _a }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill={"none"} stroke="currentColor" strokeWidth={2} className="w-6 h-6 flex-shrink-0">
...
function ProfiloIcon({ active: _a }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill={"none"} stroke="currentColor" strokeWidth={2} className="w-6 h-6 flex-shrink-0">
